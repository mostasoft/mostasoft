    ...
    <section className="py-16 bg-gray-100 text-black">
      <div className="max-w-6xl mx-auto px-6 text-center">
       ...
       <h2 className="text-3xl md:text-4xl font-bold mb-4">
          Rwliable Services <br/> <span className="text-[var(--MostUsed-color)]">We Offer</span>
        </h2>
       ...
       <div className=" flex justify-center p-5">
        <button className="btn-glass bg-[var(--MostUsed-color)] hover:translate-x-2 font-bold text-white"> Load More Services</button></div>
    </section>
  );
}
