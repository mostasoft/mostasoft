...
const UspSection = () => {
  return (
    <div className="p-6 bg-gray-100 space-y-3">
      <div className="flex gap-2 lg:p-4 font-bold text-xl lg:text-4xl justify-center items-center">
        USP Of <span className="text-[var(--MostUsed-color)]">MostaSoft</span>
      </div>
      <div className="grid grid-cols-1 space-y-2  space-x-4 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4">
        <div className=" p-4 btn-glass">
          <div className="space-y-2">
            ...
            <button className="btn-glass hover:translate-x-2 text-white transition duration-300 font-semibold bg-[var(--MostUsed-color)]">
              Start Now
            </button>
          </div>
        </div>
