      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-16 relative z-10">
        ...
        <div className="flex-1 text-center md:text-left space-y-6">
          ...
          <h1 className="text-3xl md:text-5xl lg:text-5xl font-extrabold text-gray-900 leading-tight tracking-tight bg-clip-text bg-gradient-to-r from-blue-500 via-blue-400 to-blue-600">
            Transform Your Footage <br className="hidden md:block" /> Into Stunning Videos
          </h1>

          <p className="text-gray-700 text-lg md:text-xl leading-relaxed max-w-lg mx-auto md:mx-0">
            At MostaSoft, we create professional video editing solutions that make your content shine. From color grading and motion graphics to seamless transitions, we bring your vision to life with precision and creativity.
          </p>
            ...
            {[
              {
                ...
                desc: "High-quality cuts, transitions, and color grading for a polished look.",
              },
              {
                icon: "⚡",
                title: "Fast Turnaround",
                desc: "Quick edits without compromising quality, ready for all platforms.",
              },
              {
                icon: "🌐",
                title: "Motion Graphics",
                desc: "Engaging animations and effects to captivate your audience.",
              },
              {
                icon: "🛡️",
                title: "High-Resolution Output",
                desc: "HD, 4K, and social-media-ready videos optimized for performance.",
              },
            ].map((feature, index) => (
        ...
        <div className="flex-1 relative flex flex-col items-center md:items-end">
          ...
          <div className="relative z-10 drop-shadow-2xl">
            <Image
              ...
              alt="Professional video editing illustration"
              width={1000}
              height={1000}
