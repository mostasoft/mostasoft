      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-16 relative z-10">
        ...
        <div className="flex-1 text-center md:text-left space-y-6">
          ...
          <h1 className="text-3xl md:text-5xl lg:text-5xl font-extrabold text-gray-900 leading-tight tracking-tight bg-clip-text bg-gradient-to-r from-blue-500 via-blue-400 to-blue-600">
            Build Modern <br className="hidden md:block" /> WordPress Websites
          </h1>

          <p className="text-gray-700 text-lg md:text-xl leading-relaxed max-w-lg mx-auto md:mx-0">
            At MostaSoft, we deliver custom WordPress solutions tailored to your business. From responsive themes to advanced plugins, we help you create high-performance, scalable, and visually stunning WordPress websites.
          </p>
            ...
            {[
              {
                icon: "💻",
                title: "Custom Themes",
                desc: "Tailored WordPress themes that reflect your brand.",
              },
              {
                icon: "⚡",
              ...
              },
              {
                icon: "🌐",
                title: "SEO Friendly",
                desc: "Built with best practices for better search engine performance.",
              },
              {
                icon: "🛡️",
                title: "Secure & Fast",
                desc: "High-performance WordPress websites with security in mind.",
              },
            ].map((feature, index) => (
        ...
        <div className="flex-1 relative flex flex-col items-center md:items-end">
          ...
          <div className="relative z-10 drop-shadow-2xl">
            <Image
              src="/WordPress.jpg"
              alt="Custom WordPress development illustration"
              width={1000}
              height={1000}
